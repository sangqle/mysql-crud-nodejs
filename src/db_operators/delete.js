...
const deleteOne = (connection, table_name, field, where) => new Promise((resolve, reject) => {
...
const deleteBook = (connection, table_name, field1, where1, field2, where2) => new Promise((resolve, reject) => {
	let sql = `DELETE FROM ${table_name}
